  ...
  `}
        ...
        >
            ...
            {statusMessage && (
                <div
                    className={`
    fixed z-50 px-6 py-3 rounded-xl text-sm font-medium shadow-lg transition-all duration-300
    flex items-center gap-3 bg-opacity-90
    ${statusType === "success"
    ...
    /* ≥ sm: bottom-left and no horizontal translate */
